# https://github.com/zyushun/hessian-spectrum/blob/master/language_models/hessian_spectrum.py
...
class Hessian(object):
    ...
    def load_curve_full(self):
        ...
        plt.legend()
        plt.title(f'model at interation {self.ckpt_iteration}')
        plt.savefig(self.file_dir+f'/spectrum_full_hessian_{self.ckpt_iteration}.png')
        plt.close()
        ...
        plt.legend()
        plt.title(f'model at interation {self.ckpt_iteration}')
        plt.savefig(self.file_dir+f'/spectrum_log_full_hessian_{self.ckpt_iteration}.png')
        plt.close()
